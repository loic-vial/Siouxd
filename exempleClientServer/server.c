/* Server.c
The server program will look at the directory of the machine on which the server has been run and return back to the 
client the listing directory. 
...
#define PORT 		4728 /* le port en decimal est 4725*/
#define DIRSIZE 	8192
...
main()
{
	...
	/* if you want to see the ip address and port of the client, uncomment the 
    	next two lines */
	printf("Hi there, from ");
       
 	/*printf("Hi there, from  %s\n",inet_ntoa(pin.sin_addr.s_addr));*/
;
